...
// Componente completamente estático para build de Capacitor
function BisonteStaticPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              ...
              onClick={() => {
                ...
                if (window.confirm('Demo: ¿Simular login exitoso?')) {
                  alert('¡Login exitoso! Redirigiendo a la app...');
                  // En una app real, aquí se navegaría al home
                }
              }}
            >
              Iniciar Sesión
            ...
            <button
              ...
              onClick={() => {
                alert('Demo: Login con Google no implementado en versión estática');
              }}
            >
          ...
          <div className="text-center mt-6">
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                alert('Demo: Recuperar contraseña no implementado en versión estática');
              }}
            >
          ...
          <div className="text-center mt-4">
            ...
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                alert('Demo: Registro no implementado en versión estática');
              }}
            >
              Regístrate aquí
            </a>
      ...
      <div className="text-center mt-8 pb-8">
        ...
        <p className="text-blue-200 text-xs mt-2">
          Versión estática para móvil - Demo funcional
        </p>
      </div>
    </div>
  );
...
export default BisonteStaticPage;
