  ...
  useEffect(() => {
    const processAuth = async () => {
      try {
        ...
        let clientId;
        try {
          const configResp = await fetch('https://bisonte-api.vercel.app/api/public/config');
          if (configResp.ok) {
        ...
        const backendResponse = await fetch('https://bisonte-api.vercel.app/api/auth/google', {
          method: 'POST',
